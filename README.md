...
In a 30 mL coffee, a mild capsule usually gives **40–60 mg**, while a strong or “intense” capsule typically gives **70–100 mg**.  
Values vary between brands — mild lungo-style capsules are often 100% Arabica, while intense or ristretto capsules usually include Robusta, which naturally contains more caffeine.

#### `LAMBDA` [mL]  
Controls how fast the extraction curve decays.  
It works like a *time constant*, but applied to **volume** instead of time.  
A value around **13.6 mL** means that a 15 mL extraction from a new capsule yields roughly **75% of `CAFFEINE_30`**, which is a good approximation for most cases.
